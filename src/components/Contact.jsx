    ...
    <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
      ...
      >
        ...
        <div className="flex justify-between items-center gap-5">
          ...
          <div className='flex justify-end items-center m-3 gap-1'>
             <div onClick={() => window.open  (github_url, "_blank")}
              className='w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'>
                    <FaGithub  style={{fontSize: "25px"}}/>
              </div>
              <div onClick={() => window.open(linkedin_url, "_blank")}
              className='w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'>
                    <FaLinkedin style={{fontSize: "25px"}} />
              </div>
              <div onClick={() => window.open(insta_url, "_blank")}
              className='w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'>
